    ...
    methods
        ...
        function Waveforms = GetRawV1ContinuousWaveforms(...
            ...
            if length(aChannelsToLoad) == 1
                ...
                fread(this.FileID, aChannelsToLoad - 1, '1*int16=>int16');
                fWaveform = fread(this.FileID, fNumSamples / aSubsamplingFactor, '1*int16=>int16',  2* ((fNumChannels * aSubsamplingFactor)-1) );
                fChannelMapping = aSourceSet.ChannelArray.Channels(aChannelsToLoad);
                
                fWaveform = Waveform(fChannelMapping, fStart, fWaveform, aSourceSet, aSubsamplingFactor);
                ...
                fTempChannelData = fread(this.FileID, fNumSamples, [num2str(fNumChannels) '*int16=>int16'], ((2*(fNumChannels))*(aSubsamplingFactor-1)));
